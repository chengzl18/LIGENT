...
from ligent.mlagents_envs.exception import UnityCommunicationException
from ligent.mlagents_envs.side_channel import SideChannel, IncomingMessage, OutgoingMessage
from ligent.mlagents_envs.communicator_objects.training_analytics_pb2 import (
...
class DefaultTrainingAnalyticsSideChannel(SideChannel):
    ...
    def environment_initialized(self) -> None:
        ...
        msg = TrainingEnvironmentInitialized(
            ...
            mlagents_envs_version=ligent.mlagents_envs.__version__,
