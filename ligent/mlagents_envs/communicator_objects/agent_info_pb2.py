...
from ligent.mlagents_envs.communicator_objects import observation_pb2 as mlagents__envs_dot_communicator__objects_dot_observation__pb2
...
AgentInfoProto = _reflection.GeneratedProtocolMessageType('AgentInfoProto', (_message.Message,), dict(
  ...
  __module__ = 'ligent.mlagents_envs.communicator_objects.agent_info_pb2'
