...
from ligent.mlagents_envs.communicator_objects import space_type_pb2 as mlagents__envs_dot_communicator__objects_dot_space__type__pb2
...
ActionSpecProto = _reflection.GeneratedProtocolMessageType('ActionSpecProto', (_message.Message,), dict(
  ...
  __module__ = 'ligent.mlagents_envs.communicator_objects.brain_parameters_pb2'
